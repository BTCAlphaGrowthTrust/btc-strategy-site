 ...
 * line + verification language — so the bar would misread as a claim about it. It is suppressed there.
 *
 * The "dual-verified" copy is built HERE (client side) from numeric props, so on /buy-program the
